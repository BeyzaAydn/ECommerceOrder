...
namespace Ecommerce.MVC.Areas.Administrator.Controllers
{
    ...
    public class AppUserController : Controller
    {
        ...
        {
            //update gelen bilgileri ilk olarak veritabanında bu kullanıcın kontrolü sağlamamız gerekiyor ardından _userManager sınıfını kullanarak ilgili değişiklikleri gerçekleştirebilirsiniz.
